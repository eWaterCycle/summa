#ifndef SUMMA_BMI_DEFINED_HXX
#define SUMMA_BMI_DEFINED_HXX

#include "bmi_class.h"

class SummaBmi: public Bmi
{
  public:
    ...
    int get_input_var_names(char **names) const override;
    int get_output_var_names(char **names) const override;
